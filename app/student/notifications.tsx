...
interface Notification {
  id: number;
  type: 'grade' | 'attendance' | 'fee' | 'event' | 'announcement' | 'assignment';
  title: string;
  message: string;
  time: string;
  isRead: boolean;
  ...
  const notifications: Notification[] = [
    {
      ...
      message: 'You received an A in Mathematics Quiz - Chapter 5. Great job!',
      time: '2 hours ago',
      isRead: false,
    ...
    },
    {
      ...
      message: 'Your tuition fee of $450.00 is due by Oct 30. Avoid late fees by paying on time.',
      time: '5 hours ago',
      isRead: false,
      actionLabel: 'Pay Now',
    },
    {
      ...
      message: 'Science Fair registration is now open! Showcase your project and win exciting prizes.',
      time: '1 day ago',
      isRead: false,
    ...
    },
    {
      ...
      message: 'Physics homework on Thermodynamics has been assigned. Due date: Oct 25.',
      time: '1 day ago',
      isRead: true,
    ...
    },
    {
      ...
      message: 'Your attendance has been marked as present for all classes today.',
      time: '2 days ago',
      isRead: true,
    },
    {
    ...
    },
    {
      ...
      message: 'Your mid-term report card is now available. Check your progress!',
      time: '1 week ago',
      isRead: true,
